class CurrentShippingModel {
  ...
  factory CurrentShippingModel.fromJson(Map<String, dynamic> json) => CurrentShippingModel(
    status: json["status"],
    data: CurrentShippingResult.fromJson(json["data"]),
...
class CurrentShippingResult {
  ...
  factory CurrentShippingResult.fromJson(Map<String, dynamic> json) => CurrentShippingResult(
    id: json["id"],
    userId: json["user_id"],
