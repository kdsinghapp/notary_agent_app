class GetNewPendingBookingModel {
  String? status;
  List<GetNewPendingBookingData>? data;
  String? message;

  GetNewPendingBookingModel({this.status, this.data, this.message});

  GetNewPendingBookingModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = <GetNewPendingBookingData>[];
      json['data'].forEach((v) {
        data!.add(GetNewPendingBookingData.fromJson(v));
      });
    }
...
class GetNewPendingBookingData {
  int? id;
  String? userId;
  String? driverId;
  String? driverIds;
  ...
  GetNewPendingBookingData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
