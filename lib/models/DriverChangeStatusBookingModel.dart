class DriverChangeStatusBookingModel {
  String? status;
  DriverChangeStatusBookingData? data;
  String? message;

  DriverChangeStatusBookingModel({this.status, this.data, this.message});

  DriverChangeStatusBookingModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    data = json['data'] != null ? DriverChangeStatusBookingData.fromJson(json['data']) : null;
...
class DriverChangeStatusBookingData {
  int? id;
  String? userId;
  String? driverId;
  String? driverIds;
  ...
  DriverChangeStatusBookingData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
