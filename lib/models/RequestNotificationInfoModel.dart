class RequestNotificationInfoModel {
  String? message;
  List<RequestNotificationResult>? requestId;
  String? status;

  RequestNotificationInfoModel({this.message, this.requestId, this.status});

  RequestNotificationInfoModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['request_id'] != null) {
      requestId = <RequestNotificationResult>[];
      json['request_id'].forEach((v) {
        requestId!.add(RequestNotificationResult.fromJson(v));
      });
    }
    status = json['status'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (requestId != null) {
      data['request_id'] = requestId!.map((v) => v.toJson()).toList();
    }
    data['status'] = status;
    return data;
  }
...
class RequestNotificationResult {
  int? id;
  String? userId;
  String? driverId;
  String? driverIds;
  ...
  RequestNotificationResult.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
