class GetDriverPendingBookingModel {
  String? status;
  List<GetDriverPendingBookingData>? data;
  String? message;

  GetDriverPendingBookingModel({this.status, this.data, this.message});

  GetDriverPendingBookingModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = <GetDriverPendingBookingData>[];
      json['data'].forEach((v) {
        data!.add(GetDriverPendingBookingData.fromJson(v));
      });
    }
...
class GetDriverPendingBookingData {
  int? id;
  String? userId;
  String? driverId;
  String? driverIds;
  ...
  GetDriverPendingBookingData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
    ...
    driverReason = json['driver_reason'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['driver_reason'] = driverReason;
    data['estimate_time'] = estimateTime;
    data['estimate_distance'] = estimateDistance;
    return data;
  }
}
