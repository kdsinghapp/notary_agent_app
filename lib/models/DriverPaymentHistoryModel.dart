class DriverPaymentHistoryModel {
  ...
  int? toDayEarning;
  int? weeklyEarning;
  List<DriverPaymentHistoryResult>? result;
  ...
  DriverPaymentHistoryModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    toDayEarning = json['to_day_earning'];
    weeklyEarning = json['weekly_earning'];
    if (json['result'] != null) {
      result = <DriverPaymentHistoryResult>[];
      json['result'].forEach((v) {
        result!.add( DriverPaymentHistoryResult.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['to_day_earning'] = toDayEarning;
    data['weekly_earning'] = weeklyEarning;
    if (result != null) {
...
class DriverPaymentHistoryResult {
  int? id;
  String? userId;
  String? driverId;
  String? driverIds;
  ...
  DriverPaymentHistoryResult.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
