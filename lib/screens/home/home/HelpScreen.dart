...
class _HelpScreenState extends State<HelpScreen> {
  ...
  getHelpApi() async {
    try {
      ...
      if (helpModel!.status == '1') {
        questionStatusList = List<bool>.generate(
            helpModel!.data!.length, (int index) => false,
            growable: true);
        setState(() {
          pageLoading = false;
          presentData = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: appBar(context: context, title: "HELP"),
        body: pageLoading
            ? const Center(
            ...
            : presentData
                ? Padding(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          const Text(
                            'Getting started with Notary Mobility',
                            style: TextStyle(
                ...
                : const Center(
                    child: Text(
                      "There are not present any question",
                      style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 15,
