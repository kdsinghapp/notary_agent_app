...
class _NewDashboardScreenState extends State<NewDashboardScreen> {
  ...
  LatLng _initialposition =
      LatLng(startLocation.value.latitude, startLocation.value.latitude);
  ...
  Future<void> acceptRejectRequest(
    ...
    try {
      String url =
          "https://dcmdmobilenotary.com/laravel/api/get_driver_change_status?request_id=$requestId&status=$status&agent_id=$agent_id";
  ...
  getBookingAll() async {
    ...
    try {
      final res =
          await api().post('get_request_info', data: {"request_id": id});
      print("res from login data2 ------------------${res.data}");
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          acceptRejectRequest(
                              context, 'Cancel_by_driver', model.id.toString());
                          Navigator.pop(context);
                        },
                        child: Container(
                          height: 40,
                      ...
                      GestureDetector(
                        onTap: () async {
                          acceptRejectRequest(
                              context, 'Accept', model.id.toString());
                          Navigator.pop(context);
                        },
                        child: Container(
                          height: 40,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () async {
                          acceptRejectRequest(
                              context, 'Accept', requestIdModel!.id.toString());
                          Navigator.pop(context);
                        },
                        child: Container(
                          height: 40,
  ...
  getRecentPendingBookingApi() async {
    ...
    try {
      final res = await api()
          .post('get_driver_new_pending_booking', data: {"agent_id": agent_id});
      print(
          "res get driver new pending booking  ------------------${res.data}");
                ...
                child: Column(
                  children: [
                      ...
                      leading: SizedBox(
                        ...
                        child: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl: '${driverData!.data!.image}',
                            height: 60,
                            width: 60,
                            fit: BoxFit.fill,
                    ...
                    ListTile(
                      ...
                      title: const CustomText(
                          text: 'My wallet', textColor: Colors.white),
                    ),
                    ListTile(
                      onTap: () {
                        context.pop();
                      ...
                      leading: SizedBox(
                          ...
                          width: 20.0, // fixed width and height
                          child:
                              Image.asset('assets/icons/signing_stering.png')),
                      title: const CustomText(
              ...
              title: CustomText(
                  text: 'Current Shipping', textColor: Colors.white),
                    ...
                    ListTile(
                      ...
                      title: const CustomText(
                          text: 'Live Chat', textColor: Colors.white),
                    ),
                    ListTile(
                      onTap: () {
                        context.pop();
                    ...
                    ListTile(
                      ...
                      title: const CustomText(
                          text: 'Settings', textColor: Colors.white),
                    ),
                    ListTile(
                      onTap: () async {
                        context.pop();
                      ...
                      title: const CustomText(
                          text: 'Credit Card', textColor: Colors.white),
                    ),
                    ListTile(
                      onTap: () {
                        logout();
                      ...
                      title: const CustomText(
                          text: 'Log Out', textColor: Colors.white),
                    ),
                  ],
                ),
              ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: Image.asset(
                                      tabIndex == 3
                                          ? 'assets/icons/signing_fill.png'
                                          : 'assets/icons/signing.png',
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                  CustomText(
