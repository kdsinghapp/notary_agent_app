...
class _AddStripeXpressState extends State<AddStripeXpress> {
  ...
  Future<void> getUserProfile() async {
    ...
    if (userProfileModel!.status == "true") {
      print(
          'Stripe Url:-${userProfileModel!.data![0].stripLoginLinkInStripeWebsite}');
                  ...
                  haveAccount
                      ? ListTile(
                          onTap: () {
                            ...
                            context.navigate(() => OpenStripHere(
                                stripUrl: userProfileModel!.data![0]
                                        .stripLoginLinkInStripeWebsite ??
                                    '',
                                userId:
                                    userProfileModel!.data![0].id.toString()));
                          },
                          leading: const Icon(
                            Icons.add_circle,
                            size: 25,
                      ...
                      : ListTile(
                          onTap: () async {
                            // myLauncherURL(userProfileModel!.data![0].stripLoginLinkInStripeWebsite??'');
                            await context.navigate(() => OpenStripHere(
                                stripUrl: userProfileModel!.data![0]
                                        .stripLoginLinkInStripeWebsite ??
                                    '',
                                userId:
