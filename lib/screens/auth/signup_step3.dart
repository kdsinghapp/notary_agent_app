...
class _SignUpStep3State extends State<SignUpStep3Page> {
  ...
  Map<String, dynamic> bodyParamsForSubmitSignUpStep3Form = {};
  ...
  Future<void> callingSubmitSignUpStep3Form() async {
    try {
      bodyParamsForSubmitSignUpStep3Form = {
        ...
        'Federal_Tax_Classification': checkBoxList[selectIndex],
        'Exempt_Payee_Code': payeeCodeController.text.toString(),
        'Exemption_from_FATCA_reporting_code':
            fatcaCodeController.text.toString(),
        'Address': addressController.text.toString(),
        'city': cityController.text.toString(),
        'Zip_Code': zipCodeController.text.toString(),
        'State': stateController.text.toString(),
        'Requesters_name_and_address': businessInfoController.text.toString(),
        'List_account_number_here': accountInfoController.text.toString(),
        'Social_security_number': securityNumberController.text.toString(),
        'Employer_identification_number':
            indentyNumberController.text.toString(),
        'Name_of_United_States_person': usaPersonNameController.text.toString(),
        'Date': dateController.text.toString(),
        'Signature': signatureController.text.toString(),
      };
      print(
          "bodyParamsForSubmitSignUpStep3Form:::::$bodyParamsForSubmitSignUpStep3Form");
      var res = await api().post('new_agent_quick_step_3',
          data: bodyParamsForSubmitSignUpStep3Form);
